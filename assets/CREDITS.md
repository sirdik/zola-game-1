...
Third-party assets used in this project. Most are CC0 (public domain, no
attribution legally required, but credited here anyway); one (the bear
model) is CC-BY, where attribution below satisfies the license.

## Kenney — Nature Kit

- Files: `assets/models/nature/*.glb`
...
- Files: `assets/models/animals/*.gltf`
...
- Files: `assets/models/animals/Bear.glb`
